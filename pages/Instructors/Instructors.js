...
export default function InstructorsPage() {
  ...
  return (
    <div className="flex flex-col gap-8 justify-center items-center w-full pt-8">
      <HintNavigation nameFirst={'Главная'} nameSecond={'Инструкторы'} />
      ...
      <Pagination
        totalPages={Math.ceil(instructors.length / perPage)}
        currentPage={page}
        setPage={setPage}
      />
    </div>
