...
export default function DilersFormPage() {
  ...
  const handleSubmit = (e) => {
    ...
    // Validate required radios by checking they are not empty
    const radioRequired = [
      experience,
      license,
      training,
  ...
  return (
    <form
      className="space-y-4 max-w-[830px] mx-auto w-full"
      onSubmit={handleSubmit}
    >
      <div className="bg-[#F5F5F5] rounded-xl p-6 shadow-[0px_2px_10px_rgba(0,0,0,0.1)]">
        <h3 className="text-lg ">Общая информация</h3>
      ...
      <section className="bg-[#F5F5F5] rounded-xl p-6 shadow-[0px_2px_10px_rgba(0,0,0,0.1)] w-full flex flex-col gap-4">
        <h3 className="text-lg ">Профиль деятельности</h3>
        <RadioGroup
      ...
      <section className="bg-[#F5F5F5] rounded-xl p-6 shadow-md w-full flex flex-col gap-4">
        <h3 className="text-lg">Образовательная деятельность</h3>
        <RadioGroup
      ...
      <section className="bg-[#F5F5F5] rounded-xl p-6 shadow-md w-full flex flex-col gap-4">
        <h3 className="text-lg">Коммерческая инфраструктура</h3>
        <RadioGroup
      ...
      <section className="bg-[#F5F5F5] rounded-xl p-6 shadow-md w-full flex flex-col gap-4">
        <h3 className="text-lg">Продвижение и маркетинг</h3>
        <MultiSelect
      ...
      <section className="bg-[#F5F5F5] rounded-xl p-6 shadow-md w-full flex flex-col gap-4">
        <h3 className="text-lg">Регион и масштабы деятельности</h3>
        <RadioGroup
      ...
      <section className="bg-[#F5F5F5] rounded-xl p-6 shadow-md w-full flex flex-col gap-4">
        <h3 className="text-lg">Дополнительная информация</h3>
        <TextAreaField
